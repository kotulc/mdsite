...
`mdsite` provides a minimal, mobile-first site template designed to work at the end of a
...
The "NLP" in `mdsite` refers to a set of built-in and planned intelligent features:
...
`mdsite` is the rendering and build step at the end of the [`mdpub`](https://github.com/kotulc/nlp-mdpub)
